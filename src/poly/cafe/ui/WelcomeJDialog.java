...
public class WelcomeJDialog extends javax.swing.JDialog implements WelcomeController {
            ...
            try { 
                ...
                javax.swing.SwingUtilities.invokeLater(() -> {
                    try {
                        ...
                        XDialog.alert("Có lỗi khi đóng màn hình chào: " + ex.getMessage());
                    }
                });
            } catch (InterruptedException ex) { 
                XDialog.alert("Có lỗi xảy ra trong quá trình khởi động!");
                System.exit(1); 
            } 
        });
        loadingThread.setDaemon(true); // Thread sẽ tự động kết thúc khi app đóng
        loadingThread.start(); 
    }
    ...
    @Override
    public void exit() {
        if (!isClosing && XDialog.confirm("Bạn có muốn thoát khỏi ứng dụng không?")) {
            isClosing = true;
            System.exit(0);
        }
    }
