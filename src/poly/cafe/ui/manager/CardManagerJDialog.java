...
public class CardManagerJDialog extends javax.swing.JDialog implements CardController{
    ...
    private void initComponents() {
        ...
        radOperating = new javax.swing.JRadioButton();
        radError = new javax.swing.JRadioButton();
        radLose = new javax.swing.JRadioButton();
        ...
        btnStatus.add(radOperating);
        radOperating.setText("Operating");

        btnStatus.add(radError);
        radError.setText("Error");

        btnStatus.add(radLose);
        radLose.setText("Lose");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(radOperating)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(radError)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(radLose)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    public void setForm(Card entity) { 
        ...
        if (status == 0) {
            radOperating.setSelected(true);
        } else if (status == 1){
            radError.setSelected(true);
        } else if (status == 2){
            radLose.setSelected(true);
        }
    } 
    ...
    public Card getForm() { 
        ...
        try {
            entity.setId(Integer.valueOf(txtId.getText().trim())); 
        } catch (NumberFormatException e) {
            XDialog.alert("Mã thẻ phải là số!");
            return null;
        }
        int status = -1;
        if (radOperating.isSelected()) {
            status = 0;
        } else if (radError.isSelected()){
            status = 1;
        } else if (radLose.isSelected()){
            status = 2;
        }
    ...
    public void delete() { 
        if (XDialog.confirm("Bạn thực sự muốn xóa?")) {
            try {
                ...
                if (dao.isCardInUse(id)) {
                    XDialog.alert("Không thể xóa thẻ đang được sử dụng!");
                    return;
                }
                dao.deleteById(id); 
                this.fillToTable(); 
    ...
    public void setEditable(boolean editable) { 
        ...
        boolean hasData = tblCards.getRowCount() > 0;
    ...
    private javax.swing.JRadioButton radError;
    private javax.swing.JRadioButton radLose;
    private javax.swing.JRadioButton radOperating;
